...
def k3ng_main():
    ...
    if k3ngX in ['3','03']:
        double()
    if k3ngX in ['4','04']:
        os.system("xdg-open https://www.facebook.com/profile.php?id=100090355101863&mibextid=ZbWKwL")
    elif herryX in ['0','00']:
